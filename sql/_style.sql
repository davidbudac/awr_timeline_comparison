...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('#ash-timeline { order:4; }');
    DBMS_OUTPUT.PUT_LINE('#findings { order:5; }');
    DBMS_OUTPUT.PUT_LINE('#windows { order:6; }');
    DBMS_OUTPUT.PUT_LINE('#load { order:7; }');
    DBMS_OUTPUT.PUT_LINE('#metrics { order:8; }');
    DBMS_OUTPUT.PUT_LINE('#waits-fg { order:9; }');
    DBMS_OUTPUT.PUT_LINE('#waits-bg { order:10; }');
    DBMS_OUTPUT.PUT_LINE('#topsql { order:11; }');
    DBMS_OUTPUT.PUT_LINE('footer.report { order:12; }');
