...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('#overview { order:3; }');
    DBMS_OUTPUT.PUT_LINE('#findings { order:4; }');
    DBMS_OUTPUT.PUT_LINE('#windows { order:5; }');
    DBMS_OUTPUT.PUT_LINE('#load { order:6; }');
    DBMS_OUTPUT.PUT_LINE('#metrics { order:7; }');
    DBMS_OUTPUT.PUT_LINE('#waits-fg { order:8; }');
    DBMS_OUTPUT.PUT_LINE('#waits-bg { order:9; }');
    DBMS_OUTPUT.PUT_LINE('#topsql { order:10; }');
    DBMS_OUTPUT.PUT_LINE('footer.report { order:11; }');
