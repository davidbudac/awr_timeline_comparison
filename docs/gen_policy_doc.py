...
# --------------------------------------------------------------------------
CSS = """
:root{--paper:#eceef1;--panel:#fff;--panel-2:#f4f6f8;--ink:#12161d;--ink-soft:#333a45;--muted:#5d6672;
--rule:#c4ccd6;--hairline:#d9dfe6;--accent:#1f5fa8;--accent-deep:#123a68;--accent-bg:#e0eaf4;
--crit:#b01c1c;--warn:#8a5a00;--ok:#1f7a4d;--skip:#7a828e;--crit-bg:#fbeceb;--warn-bg:#faf2df;--ok-bg:#e8f3ed;--skip-bg:#eef1f4;}
@media (prefers-color-scheme:dark){:root{--paper:#0f1319;--panel:#161b23;--panel-2:#1d232d;--ink:#e6e9ee;--ink-soft:#c9cfd8;
--muted:#8591a0;--rule:#2c3440;--hairline:#252c37;--accent:#6fa8dc;--accent-deep:#a9cdf0;--accent-bg:#172431;
--crit:#ff7b72;--warn:#e3b341;--ok:#5fd39b;--skip:#8591a0;--crit-bg:#3a1d1d;--warn-bg:#3a2f14;--ok-bg:#16301f;--skip-bg:#1d232d;}}
*{box-sizing:border-box}
body{margin:0;background:var(--paper);color:var(--ink);font:14px/1.55 -apple-system,BlinkMacSystemFont,"Segoe UI",Inter,Roboto,Helvetica,Arial,sans-serif}
main{max-width:1180px;margin:0 auto;padding:24px 16px 64px}
h1{font-size:26px;margin:0 0 4px}h2{font-size:19px;margin:36px 0 10px;padding-top:12px;border-top:1px solid var(--hairline)}
...
thead th{background:var(--panel-2);font-size:11px;text-transform:uppercase;letter-spacing:.06em;color:var(--muted);border-top:0;position:sticky;top:0}
...
.toc a{margin-right:14px;color:var(--accent-deep);font-weight:600;text-decoration:none}
...
<title>Scoring policy</title><style>{CSS}</style></head><body><main>
